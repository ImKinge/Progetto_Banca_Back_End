...
public class IbanTransactionDto implements Serializable {
    ...
    //Constructor
    public IbanTransactionDto () {}


    public IbanTransactionDto(String amount, LocalDateTime dateTransaction, String descriptionTransaction, CustomerDataDto orderer, CustomerDataDto beneficiary) {
        this.amount = amount;
